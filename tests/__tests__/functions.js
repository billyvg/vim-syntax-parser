describe('Functions', () => {
  describe('single-line', () => {
    ...
    test('function declaration keyword', () => {
      testTypes(results, 'FunctionDeclarationKeyword', [[1, 0, 8]]);
    });

    test('function declaration identifier (name)', () => {
      testTypes(results, 'FunctionDeclarationIdentifier', [[1, 9, 12]]);
    });
    ...
    test('default arguments value', () => {
      testTypes(results, 'DefaultArgument', [[1, 19, 25], [1, 32, 46]]);
    });

    test('return statement', () => {
      testTypes(results, 'ReturnKeyword', [[2, 2, 9]]);
    });
  });
  ...
  describe('multi-line', () => {
    ...
    test('function declaration keyword', () => {
      testTypes(results, 'FunctionDeclarationKeyword', [[1, 0, -1]]);
    });

    test('function declaration identifier (name)', () => {
      testTypes(results, 'FunctionDeclarationIdentifier', [[2, 2, 5]]);
    });
